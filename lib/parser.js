                ...
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        return _context2.delegateYield(_regenerator2.default.mark(function _callee() {
                            var zip, containerXml, containerJSON, opfPath, root, contentXml, contentJSON, ncxId, ncxPath, manifest, spine, tocXml, tocJSON, parsedToc, metadata, title, author, publisher, meta, flesh;
                                ...
                                while (1) {
                                    switch (_context.prev = _context.next) {
                                        ...
                                        case 4:
                                            ...
                                            contentXml = extractZipContent(opfPath)(zip);
                                            _context.next = 10;
                                            return xmlToJs(contentXml);

                                        case 10:
                                            contentJSON = _context.sent;
                                            ncxId = (0, _get3.default)(contentJSON, ['package', 'spine', 0, '$', 'toc']);
                                            ncxPath = '';
                                            ...
                                            tocXml = extractZipContent('' + root + ncxPath)(zip);
                                            _context.next = 18;
